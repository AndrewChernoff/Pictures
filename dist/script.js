...
/* harmony import */ var _modules_filterTabs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/filterTabs */ "./src/js/modules/filterTabs.js");
/* harmony import */ var _modules_forms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/forms */ "./src/js/modules/forms.js");
/* harmony import */ var _modules_inputLangText__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/inputLangText */ "./src/js/modules/inputLangText.js");
/* harmony import */ var _modules_loadMore__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/loadMore */ "./src/js/modules/loadMore.js");
...
Object(_modules_slider__WEBPACK_IMPORTED_MODULE_10__["default"])('.feedback-slider-item', 'horizontal', '.main-prev-btn', '.main-next-btn');
Object(_modules_slider__WEBPACK_IMPORTED_MODULE_10__["default"])('.main-slider-item', 'vertical');
Object(_modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"])(state);
Object(_modules_mask__WEBPACK_IMPORTED_MODULE_7__["default"])('[name="phone"]');
Object(_modules_inputLangText__WEBPACK_IMPORTED_MODULE_5__["default"])('[name="name"]');
Object(_modules_inputLangText__WEBPACK_IMPORTED_MODULE_5__["default"])('[name="message"]');
Object(_modules_loadMore__WEBPACK_IMPORTED_MODULE_6__["default"])('.button-styles', '.styles .row');
Object(_modules_calc__WEBPACK_IMPORTED_MODULE_2__["default"])(state);
Object(_modules_filterTabs__WEBPACK_IMPORTED_MODULE_3__["default"])('.portfolio-menu li', '.portfolio-block');
Object(_modules_pictures__WEBPACK_IMPORTED_MODULE_9__["default"])('.sizes-block');
...
var accordion = function accordion(headingSelector, blocksSelector) {
  var accordionHeadings = document.querySelectorAll(headingSelector);
  var blocks = document.querySelectorAll(blocksSelector);
  blocks.forEach(function (block) {
    return block.classList.add('animated', 'flipInX');
  });
...
var filterTabs = function filterTabs(menuItemsSelector, imagesSelector) {
  var menuItems = document.querySelectorAll(menuItemsSelector);
  var images = document.querySelectorAll(imagesSelector);
  var emptyTab = document.querySelector('.portfolio-no');
...
/* harmony import */ var core_js_modules_es_object_get_own_property_names__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! core-js/modules/es.object.get-own-property-names */ "./node_modules/core-js/modules/es.object.get-own-property-names.js");
...
/* harmony import */ var _DAL__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./DAL */ "./src/js/modules/DAL.js");
...
var forms = function forms(store) {
  ...
  var sendFormData = function sendFormData(formEl) {
    formEl.addEventListener('submit', function (e) {
      ...
      if (formEl.closest('.popup-design')) {
      ...
      formStatus.innerHTML = "<div>\n                <img src='".concat(message.loadingGIF, "'/>\n                <div>").concat(message.loading, "</div>\n            </div>");
      ...
      Object(_DAL__WEBPACK_IMPORTED_MODULE_15__["default"])(serverPath, obj).then(function (response) {
        console.log(response);
        console.log(obj);
        console.log(serverPath);
        formEl.style.display = 'none';
        formStatus.innerHTML = "<div>\n                    <img src='".concat(message.ok, "'> \n                    <div>").concat(message.success, "</div>\n                    </div>");
      }).then(function () {
        setTimeout(function () {
          closeModal();
          formStatus.remove();
        ...
        if (formEl.getAttribute('data-calc')) {
          ...
          try {
            for (var _iterator = Object.getOwnPropertyNames(store)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
/***/ "./src/js/modules/inputLangText.js":
/*!*****************************************!*\
  !*** ./src/js/modules/inputLangText.js ***!
  \*****************************************/
/*! exports provided: default */
...
var inputLangText = function inputLangText(selector) {
...
var loadMore = function loadMore(button, styles) {
  var row = document.querySelector(styles);
  var trigger = document.querySelector(button);

  function getStyles() {
    fetch('assets/db.json').then(function (response) {
      return response.json();
    }).then(function (data) {
      data.styles.forEach(function (_ref) {
        var src = _ref.src,
            title = _ref.title,
            link = _ref.link;
...
var modal = function modal() {
  ...
  document.addEventListener('scroll', function (e) {
    ...
    var scrollHeight = Math.ceil(documentHeight, currentScroll);
    var modifier = 200;
...
var slider = function slider(slides, direction, prevBtn, nextBtn) {
  var slidesItems = document.querySelectorAll(slides);
  var prevButton = document.querySelector(prevBtn);
  var nextButton = document.querySelector(nextBtn);
  var autoSlide;

  function hideSlides() {
    slidesItems.forEach(function (el) {
  ...
  slidesItems[0].parentNode.addEventListener('mouseenter', function () {
